 ...
 */
@ApiModel(description = "location is a pair [latitude, longitude] with the coordinates on earth in decimal notation (e.g. [40.418889, 35.89389]).")
...
public class Location {
     ...
     * @return latitude
     **/
    @ApiModelProperty(example = "5.36", required = true, value = "")
     ...
     * @return longitude
     **/
    @ApiModelProperty(example = "4.0083", required = true, value = "")

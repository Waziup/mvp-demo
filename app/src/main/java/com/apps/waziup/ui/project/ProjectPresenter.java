...
public class ProjectPresenter implements ProjectContract.Presenter {
    ...
    @Override
    public void onDomainMarkerClicked(int position) {
        view.showDomainONMap(position);
    }

    @Override
    public void onDomainEditClicked(int position) {
    ...
    @Override
    public void onDomainClicked(int position) {
        view.showDomainDetail(position);
    }
}
